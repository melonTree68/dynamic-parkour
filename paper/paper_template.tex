...
The per-family recovery results explain the HELA design. Gap traversal benefits most from teacher-student recovery because takeoff timing and landing recovery require visual information about moving support surfaces. Hurdle performance is strongest without ELA: hurdle motion is small, and collision artifacts dominate the failure mode. Tilted-pad augmentation hurts because the robot can aim for the rotation axis, making roll angle less useful and turning explicit state into a training distraction. Dynamic step is unusable in the current setup because step-actor collisions push the robot back strongly and prevent reward collection. HELA therefore routes gap state through teacher-student recovery, suppresses hurdle and tilted-pad dynamic labels, and replaces dynamic step with static \texttt{parkour\_\allowbreak step}.
