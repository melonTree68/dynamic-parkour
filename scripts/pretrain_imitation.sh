...
python train.py --no_wandb --headless --resume --resumeid imitate-base-15k --checkpoint 20000 --task a1_dynamic --proj_name imitation-pretrain-dynamic-terrain --exptid resume-from-imitate_base_15k-20k
